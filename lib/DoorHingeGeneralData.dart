...
class DoorHingeGeneralDataState extends State<DoorHingeGeneralData> {
  ...
  Widget _checkImage(){
    ...
    if (yearCtr.text != "" && basicDepthDoorCtr.text != "" && hingeSystemCtr.text != "" && materialCtr.text != "" && thermallyCtr.text != ""
      ...
      else if (hingeTypeCtr.text == FlutterI18n.translate(context, 'Barrel hinge')){
      ...
      return Column(
        children: <Widget>[
          Padding(
              ...
              child: Row(
                children: <Widget>[
                  Text(FlutterI18n.translate(context, 'Door leaf (mm)'),style: Theme.of(context).textTheme.body1, textAlign: TextAlign.left),
                  _getMandatory(true)
                ],
              )
          ),
          ...
          Padding(
              ...
              child: Row(
                children: <Widget>[
                  Text(FlutterI18n.translate(context, 'Door frame (mm)'),style: Theme.of(context).textTheme.body1, textAlign: TextAlign.left),
                  _getMandatory(true)
                ],
              )
          ),
          ...
          InkWell(
            child: Container(
              height: 50,
                ...
                child: Row(
                  children: <Widget>[
                    Text(FlutterI18n.translate(context, 'Dimension'),style: Theme.of(context).textTheme.body1, textAlign: TextAlign.left),
                    Expanded(
                      child: _getMandatory(true),
                    ),
                    Padding(
      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text(FlutterI18n.translate(context, 'Basic depth of the door leaf (mm)'),style: Theme.of(context).textTheme.body1, textAlign: TextAlign.left),
                _getMandatory(true)
              ],
            )
          ),
          ...
          Divider(height: 1),
          _constructGenericOption(FlutterI18n.translate(context, 'Material'), true, [FlutterI18n.translate(context, 'Aluminum'),FlutterI18n.translate(context, 'PVC-U'),
            FlutterI18n.translate(context, 'Steel')], materialCtr, FlutterI18n.translate(context, 'Aluminum')),
          Divider(height: 1),
          _constructGenericOption(FlutterI18n.translate(context, 'Thermally'), true, [FlutterI18n.translate(context, 'Thermally broken door'),
            FlutterI18n.translate(context, 'Thermally non broken door')], thermallyCtr, FlutterI18n.translate(context, 'Thermally broken door')),
          Divider(height: 1),
          _constructGenericOption(FlutterI18n.translate(context, 'Door opening'), true, [FlutterI18n.translate(context, 'Inward'),FlutterI18n.translate(context, 'Outward')],
              doorOpeningCtr, FlutterI18n.translate(context, 'Inward')),
          Divider(height: 1),
          _constructGenericOption(FlutterI18n.translate(context, 'Fitted'), true, [FlutterI18n.translate(context, 'Flush-fitted'),FlutterI18n.translate(context, 'Face-fitted')],
              fittedCtr, FlutterI18n.translate(context, 'Flush-fitted')),
          Divider(height: 1),
          _constructGenericOption(FlutterI18n.translate(context, 'Hinge type'), true, [FlutterI18n.translate(context, 'Surface-mounted door hinge'),FlutterI18n.translate(context, 'Barrel hinge'),
            FlutterI18n.translate(context, 'Weld-on hinge'),FlutterI18n.translate(context, '100 concealed hinge'),FlutterI18n.translate(context, '180 concealed hinge'),
            FlutterI18n.translate(context, '2-part'),FlutterI18n.translate(context, '3-part')], hingeTypeCtr, FlutterI18n.translate(context, 'Surface-mounted door hinge')),
          Divider(height: 1),
          _getSurface(),
          _getBarrel()
        ],
