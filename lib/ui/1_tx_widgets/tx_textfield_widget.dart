...
class TXTextFieldWidget extends StatefulWidget {
  ...
  const TXTextFieldWidget(
      ...
      this.multiLine,
      this.focusNode,
      this.onSubmitted, this.fontSize = 12})
      : super(key: key);
...
class _TXTextFieldWidgetState extends State<TXTextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return CupertinoTextField(
      ...
      style: TextStyle(fontSize: widget.fontSize, color: Colors.black, letterSpacing: .05),
      placeholderStyle: TextStyle(fontSize: widget.fontSize, color: R.color.gray, letterSpacing: .05),
