...
class User {
  ...
  String gender,hybrisId,country,zip,email,supplierNumber,salutation,allgroups,
      firstName,lastName,/*city,*/customerNumber, type,targetgroup,usergroups,cmsId,cpsUserId,
      street,activeB2BUnit;
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    User user = User(
      ...
      json['street'],
      json['activeB2BUnit'],
      (json['active']).toString() == "true" ? true : false,
      (json['isInternalUser']).toString() == "true" ? true : false,
      (json['registrationPending']).toString() == "true" ? true : false
    );
...
class B2bUnit {
  ...
  factory B2bUnit.fromJson(Map<String, dynamic> json) {
    B2bUnit b2bUnit = B2bUnit(
        (json['canBuy']).toString() == "true" ? true : false,
        (json['seePrices']).toString() == "true" ? true : false,
        json['id'],
        json['name']);
    return b2bUnit;
  }
