...
class LoginState extends State<LoginV> {
  ...
  Future _login(BuildContext context) async {
    ...
    if (usernameController.text == "" || passwordController.text == "") {
      _showDialog(context, "Error", FlutterI18n.translate(context, 'Missing data'));
    }
    else {
      setState(() {
        _saving = true;
    ...
    return ModalProgressHUD(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(FlutterI18n.translate(context, 'login'),style: Theme.of(context).textTheme.body1),
          leading: IconButton(
        ...
        children: <Widget>[
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: FlutterI18n.translate(context, 'E-mail / username'),
          ...
          Row(
            children: <Widget>[
              CupertinoButton(
                child: Text(
                  FlutterI18n.translate(context, 'Forgotten your password?'),
                  style: TextStyle(
                    fontSize: 14,
                    color: Theme.of(context).primaryColor,
                  ),
