...
//                            await takeScreenShoot();
  ...
  Future<void> takeScreenShoot() async {
    ...
    await _sc1
        .capture(
            path: '$directory/$fileName.png', delay: Duration(milliseconds: 10))
        .then((File image) {
  ...
  _saveArticle() async {
    ...
    sliding.dimensionA = aCtr.text;
    sliding.dimensionB = bCtr.text;
    sliding.dimensionC = cCtr.text;
    sliding.dimensionD = dCtr.text;
